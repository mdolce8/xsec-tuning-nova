/*
 * generate_nd_allnumu_ehadvis_charged_vs_neutral_hadrons.C:
 *    Create PredInterp objects from ND Prod5.1 MC
 *    in EHad Vis for Inclusive sample and also
 *    True Npi^+- > 0. .
 *    Xsec systematics: RESvpvn , DISHadro.
 *
 *    From Jeremy W's request for Neutrino talk.
 *
 *    Author: M. Dolce
 *    Date:  May 2024
 *
...
// =====================================================================================================
void generate_nd_allnumu_ehadvis_charged_vs_neutral_hadrons(const std::string& beam,        // fhc or rhc
