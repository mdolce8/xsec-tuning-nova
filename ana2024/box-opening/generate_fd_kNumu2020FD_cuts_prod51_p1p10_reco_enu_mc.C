/*
 * generate_fd_kNumu2020FD_cuts_prod5.1_p1p10_reco_enu_mc.C:
...
// =====================================================================================================
void generate_fd_kNumu2020FD_cuts_prod51_p1p10_reco_enu_mc(const std::string& beam,        // fhc or rhc
...
//  loader.SetLoaderPath(defMC_Tau, caf::kFARDET, ana::Loaders::kMC, DataSource::kBeam, ana::Loaders::kTauSwap);
  ...
  // Cumulative effect of cuts: last entry is kNumu2020FD
